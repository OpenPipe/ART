...
uv pip install -U \
  ...
  "openpipe-art[backend,langgraph]>=0.4.9"
```
...
- Install ART with the correct extras: `uv pip install -U --extra-index-url https://download.pytorch.org/whl/cu128 "openpipe-art[backend,langgraph]>=0.4.9"`
