...
In this Quick Start tutorial, we'll be training Qwen 3.8 27B to play [2048](https://play2048.co/), a simple game that requires forward planning and basic math skills.

<Info>

Reading time: <b>15 min</b>

Training time and cost depend on your run settings and W&B plan.

</Info>

The notebook installs the published `openpipe-art==0.5.20` package and uses
`Qwen/Qwen3.8-27B` with `ServerlessBackend`; no local GPU is required.
...
Use a W&B account with access to W&B Training.
