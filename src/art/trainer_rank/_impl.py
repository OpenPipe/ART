...
# ``_slots`` holds TrainerRank method bodies and reads ``_impl`` names such as
# ``Unset`` at definition time, so it is imported once those exist and before
# the class body binds its functions.
